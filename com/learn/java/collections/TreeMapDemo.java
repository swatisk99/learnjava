...
public class TreeMapDemo {
	...
	public static void main(String[] args) {
		//Map in sorted order
		TreeMap<String,String> empDetails = new TreeMap<>(new EmpComparator());
		String empName,empId;
		System.out.println("Number of employees : ");
		try(Scanner scanner= new Scanner(System.in)){
			int empStrength = scanner.nextInt();
			for(int i = 1;i <= empStrength; i++ , empDetails.putIfAbsent(empId , empName)) {
		...
		Entry<String,String> empEntry = empDetails.ceilingEntry("1500");	
