...
class ThisClass implements OuterInterface.InnerInterface, OuterInterface {
	...
	public void sayInner() {
		System.out.println("I'm from Inner Interface"); // If only inner iface was implemented OuterInterface.PI could
														// still be printed
	}
}
...
public class ImplementNestedIface {
	public static void main(String... args) {
		...
		// object2.sayInner(); //The method sayInner() is undefined for the type
		// OuterInterface
		object2.sayOuter();

		OuterInterface.InnerInterface object3 = new ThisClass();
		object3.sayInner();
		// object3.sayOuter(); //The method sayOuter() is undefined for the type
		// OuterInterface.InnerInterface

		OuterInterface.saySomething();
		// OuterInterface.sayDefault(); //Cannot make a static reference to the
		// non-static method sayDefault() from the type OuterInterface
		object2.sayDefault();
